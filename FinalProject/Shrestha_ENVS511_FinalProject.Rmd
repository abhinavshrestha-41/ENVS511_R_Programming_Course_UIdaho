...
*To run this script on your own console, please un-comment and assign file location and destinations appropriately*
...
Creating columns in the dummy dataframes to specify from where the point cloud data is coming from (green tree vs gray tree vs top-kill tree)
```{r warning=FALSE}
